...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-4'>
      <Link to="/">
        <img src={assets.favicon} alt="" className='w-28 sm:w lg:w-40'/>
      </Link>

      <div>
        {user ? (
          <div className='flex items-center gap-2 sm:gap-3 rounded-full hover:scale-105 transition-all duration-700'>
            <button onClick={() => navigate('/buy')} className="flex items-center gap-2 rounded-full bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3">
